...
```html
<link href="https://unpkg.com/webkul-micron@1.1.5/dist/css/micron.min.css" type="text/css" rel="stylesheet">
<script src="https://unpkg.com/webkul-micron@1.1.5/dist/script/micron.min.js" type="text/javascript"></script>
```
